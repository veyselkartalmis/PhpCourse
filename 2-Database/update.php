<?php
    ...
    // Veritabanımdan derslerin ID'sini virgülle parçalayarak çektim.
...
<form action="" method="post">
    ...
    <!-- Forma bilgilerimi tek tek aktardım $ders["istenen_deger"] mantığıyla. -->
    Başlık: <br>
    <input type="text" name="baslik" value="<?php echo $ders["baslik"]?>"> <br> <br>

    İçerik: <br>
    <textarea name="icerik" cols="30" rows="10"><?php echo $ders["icerik"]?></textarea> <br> <br>
